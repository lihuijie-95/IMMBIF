...
SingelModal1_ACC = best_ave(1)
SingelModal1_AUC = best_ave(8)
% save('resSingleModal1.mat','best_ave','best_ave_all','bestROClabel_all','besttlabel_all','bestres_all');
