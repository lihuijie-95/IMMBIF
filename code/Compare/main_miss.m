...
for ln = 1 : lnnum
    ...
    for index_beta = 0:1:10
        ...
        for ki = 1:k_fold
            ...
            train_features{2} = [modalmiss_comp; modalmiss_miss];
        ...
        ave_all(ln,i,:) = [mean(res,1) auc std(res,1,1) beta missrate k_fold ln];
...
Miss20_ACC = best_ave(1)
Miss20_AUC = best_ave(8)
% save('resMiss0.6.mat','best_ave','best_ave_all','bestROClabel_all','besttlabel_all','bestres_all');
